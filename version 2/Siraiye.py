		...
		if ( nick != Siraiye.nick ):
			...
			if Poll.Is():
				if not Poll.CheckAndserw( nick ):
					Siraiye.SendMsg( "Witaj, czy weźmiesz udział w ankiecie? Jeśli tak, odpowiedź na poniższe pytanie pisząc tutaj: tak lub nie, jesli nie chcesz odpowiadać - zignoruj tą wiadomość. Dziekuje:)", nick )
